    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <ul class="navbar-nav">
            <router-link tag="li" class="nav-link" to="/" exact>
                <a><img src="/static/img/LePetitFrigo.png"></a>
            </router-link>

            <li class="nav-link">
                <router-link tag="a" class="btn btn-secondary" to="/profile" exact v-show="userIsRegistered">
                    <a>Profile</a>
                </router-link>
                <router-link tag="a" class="btn btn-default" to="/register" exact v-show="!userIsRegistered">
