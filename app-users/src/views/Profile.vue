        ...
        <div class="row">
            <div class="col-md-3 margin-bottom">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Nombre des minutes investi" type="number" v-model="userTime">
                </div>
            ...
            <div class="col-md-3">
                ...
                <p>
                    <strong>Account</strong>: {{ balance }} ETH
                </p>
                <p>
                    <strong>Identifier</strong>: {{ userId }}
                </p>
            </div>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                userTime: 0, // how many minutes contributed
                    ...
                    window.bc.contract().getOwnProfile.call({ from: account },
                        (error, userDet) => {
                            if (userDet) {
                                ...
                                this.userTime = userDet[2];
                                // bytes32 format so it has to be trasformed to stirng
                                this.userStatus = this.toAscii(userDet[3]);
                            }
